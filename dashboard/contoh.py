...
def create_sum_order_items_df(df):
    create_sum_order_items_df = df.groupby('product_name').quantity_x.sum().sort_values(ascending=False).reset_index()
...
def create_byage_df(df):
    ...
    byage_df['age_group'] = pd.Categorical(byage_df['age_group'],['young', 'adult', 'senior'])
    return byage_df
